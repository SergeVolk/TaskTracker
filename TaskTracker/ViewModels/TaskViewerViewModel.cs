...
{
    public class TaskViewerViewModel : INotifyPropertyChanged, IDescriptionProvider, IActivityProvider
    {
        ...
        public void Assign(Task task)
        {
            ...
            this.TaskType = task.TaskType.Name;
        ...
        {
            var ctx = e.NewValue as TaskViewerViewModel;
            if (ctx == null)
                return;

            //UpdateControls(ctx.Status);
        }*/

        //public ITaskEditViewModelProvider ViewModelProvider { get; set; }       
        ...
        {
            //var taskEditVM = ViewModelProvider?.GetViewModel(Id);
            //if (taskEditVM == null)
            ...
            if (uiService.ShowTaskEditorWindow(taskEditorVM).GetValueOrDefault())
            {
                var task = new Task
                {
                    ...
                    TaskType = repository.GetTaskTypes().FirstOrDefault(tt => tt.Name == taskEditorVM.SelectedTaskType),
